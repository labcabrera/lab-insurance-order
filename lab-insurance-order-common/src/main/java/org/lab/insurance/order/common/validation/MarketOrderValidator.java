package org.lab.insurance.order.common.validation;
...
import org.lab.insurance.order.common.Errors;
		...
		if (entity.getCurrentState() != null && entity.getDates() != null) {
			...
			case INITIAL:
				addIfNotNull(errors, checkNullValue(entity.getDates().getProcessed(),
					Errors.MarketOrder.Validation.StateInitialWithProcessedDate, ctx));
